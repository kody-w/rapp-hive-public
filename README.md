...
- `portfolio/`: every public RAPP repo's earned RAPP/1 status, one file per repo in `repos/`, the whole table in `PORTFOLIO.md`, and the badges each repo's README shows (GitHub Pages serves them).
