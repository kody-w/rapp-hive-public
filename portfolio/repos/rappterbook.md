...
status: not yet
verdict: DRIFT
evidence_commit: 0a3f1458021dbba12d975468d438a679cc7d492e
checked: 2026-09-26
checker: kody-w/rapp-1 rapp_check.py at 591e014
experimental_mentions: 4168
header: missing
version: "v1.0.0"
...
- Evidence: [`kody-w/rappterbook` at `0a3f145802`](https://github.com/kody-w/rappterbook/tree/0a3f1458021dbba12d975468d438a679cc7d492e) on `main`, checked 2026-09-26.
...
- "experimental" mentions: 4168 (whole word, any case, in tracked text files at the evidence commit, leaving out the network's own files: the repo's card `.rapp/member.md` and, in the network's public copy, `portfolio/`, `members/`, `notices/` and `PUBLISHED.md`; tracked, not a gate).
...
Clone `kody-w/rappterbook` at `0a3f145802` and `kody-w/rapp-1` at `591e014`, then run `python3 -B rapp-1/rapp_check.py rappterbook --json` from the folder that holds both.
