...
status: not yet
verdict: DRIFT
evidence_commit: 649c0c9aad8733f6ba98319ad97635ef06ae83f1
checked: 2026-09-26
...
- Evidence: [`kody-w/rappterbook` at `649c0c9aad`](https://github.com/kody-w/rappterbook/tree/649c0c9aad8733f6ba98319ad97635ef06ae83f1) on `main`, checked 2026-09-26.
...
Clone `kody-w/rappterbook` at `649c0c9aad` and `kody-w/rapp-1` at `591e014`, then run `python3 -B rapp-1/rapp_check.py rappterbook --json` from the folder that holds both.
