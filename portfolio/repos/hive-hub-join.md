...
status: certified
verdict: CLEAN
evidence_commit: ca3cfe8668e579da53b002e08fa002d30f0cdc0b
checked: 2026-09-26
...
Linked from 2: [hive-hub-mcp](hive-hub-mcp.md), [rapp-hive-public](rapp-hive-public.md).

Counted from markdown links to `github.com/kody-w/<repo>` or `kody-w.github.io/<repo>`, pin files, workflow `uses:` and `repository:` lines, and submodules, at the evidence commit; only public repos in this portfolio count.

## Check it yourself

Clone `kody-w/hive-hub-join` at `ca3cfe8668` and `kody-w/rapp-1` at `591e014`, then run `python3 -B rapp-1/rapp_check.py hive-hub-join --json` from the folder that holds both.
