...
status: certified
verdict: CLEAN
evidence_commit: c53e4f08eac7360d67522d25c66029473743507a
checked: 2026-09-26
...
- Evidence: [`kody-w/rapp-organism` at `c53e4f08ea`](https://github.com/kody-w/rapp-organism/tree/c53e4f08eac7360d67522d25c66029473743507a) on `main`, checked 2026-09-26.
...
Clone `kody-w/rapp-organism` at `c53e4f08ea` and `kody-w/rapp-1` at `591e014`, then run `python3 -B rapp-1/rapp_check.py rapp-organism --json` from the folder that holds both.
