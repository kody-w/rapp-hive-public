...
status: certified
verdict: COMPLIANT
evidence_commit: 4afb6354672f92bcd829efe12c65ced42c6e8b72
checked: 2026-09-26
checker: kody-w/rapp-1 rapp_check.py at 591e014
experimental_mentions: 162
header: present
...
![RAPP/1: certified, version v1.0.0](https://kody-w.github.io/rapp-hive-public/portfolio/badges/RAPP.svg)
...
- Evidence: [`kody-w/RAPP` at `4afb635467`](https://github.com/kody-w/RAPP/tree/4afb6354672f92bcd829efe12c65ced42c6e8b72) on `main`, checked 2026-09-26.
- Checker: [`rapp_check.py` at `591e014`](https://github.com/kody-w/rapp-1/blob/591e014ad39e223b00ab343ae26e5d9a867ebeee/rapp_check.py), verdict **COMPLIANT**, 8 passing artifact(s). The raw output stays in the maintainer's sweep folder, outside the Hive; its SHA-256 is `143ad131c37c815f240fe8d43b1026a56ccad7e903ac1b9fcd9a66860c03b6f3`.
- "experimental" mentions: 162 (whole word, any case, in tracked text files at the evidence commit, leaving out the network's own files: the repo's card `.rapp/member.md` and, in the network's public copy, `portfolio/`, `members/`, `notices/` and `PUBLISHED.md`; tracked, not a gate).
- Network header: present in `README.md`.
- Member card: [`.rapp/member.md`](https://github.com/kody-w/RAPP/blob/4afb6354672f92bcd829efe12c65ced42c6e8b72/.rapp/member.md) at the evidence commit: this repo's card in the RAPP Hive, beside its pointer [`members/RAPP.md`](https://github.com/kody-w/rapp-hive-public/blob/main/members/RAPP.md).
