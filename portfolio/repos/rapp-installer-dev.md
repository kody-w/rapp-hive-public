...
status: certified
verdict: CLEAN
evidence_commit: 452ef43ed8d6e7956a6a3d2b19a683eed2df76c7
checked: 2026-09-26
...
- Evidence: [`kody-w/rapp-installer-dev` at `452ef43ed8`](https://github.com/kody-w/rapp-installer-dev/tree/452ef43ed8d6e7956a6a3d2b19a683eed2df76c7) on `main`, checked 2026-09-26.
...
Clone `kody-w/rapp-installer-dev` at `452ef43ed8` and `kody-w/rapp-1` at `591e014`, then run `python3 -B rapp-1/rapp_check.py rapp-installer-dev --json` from the folder that holds both.
