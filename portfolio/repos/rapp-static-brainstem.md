...
status: certified
verdict: CLEAN
evidence_commit: 35cbd49ad4b25755af1c45db29aaac6aecacaef4
checked: 2026-09-25
...
![RAPP/1: certified](https://kody-w.github.io/rapp-hive-public/portfolio/badges/rapp-static-brainstem.svg)

**Certified:** rapp-1's own checker gave **CLEAN** (no RAPP artifacts, found by a complete bounded scan) at the evidence commit.

- Evidence: [`kody-w/rapp-static-brainstem` at `35cbd49ad4`](https://github.com/kody-w/rapp-static-brainstem/tree/35cbd49ad4b25755af1c45db29aaac6aecacaef4) on `main`, checked 2026-09-25.
...
Clone `kody-w/rapp-static-brainstem` at `35cbd49ad4` and `kody-w/rapp-1` at `591e014`, then run `python3 -B rapp-1/rapp_check.py rapp-static-brainstem --json` from the folder that holds both.
