...
status: certified
verdict: COMPLIANT
evidence_commit: 0da52a68d90533b04f328330378422ca53ba7d69
checked: 2026-09-26
...
Linked from 7: [hive-hub](hive-hub.md), [rapp-brainstem-plugin](rapp-brainstem-plugin.md), [rapp-hive-hub](rapp-hive-hub.md), [rapp-hive-public](rapp-hive-public.md), [rapp-lab-kit](rapp-lab-kit.md), [rapp-monorepo](rapp-monorepo.md), [rapp-skills](rapp-skills.md).

Counted from markdown links to `github.com/kody-w/<repo>` or `kody-w.github.io/<repo>`, pin files, workflow `uses:` and `repository:` lines, and submodules, at the evidence commit; only public repos in this portfolio count.

## Check it yourself

Clone `kody-w/rapp-work` at `0da52a68d9` and `kody-w/rapp-1` at `591e014`, then run `python3 -B rapp-1/rapp_check.py rapp-work --json` from the folder that holds both.
