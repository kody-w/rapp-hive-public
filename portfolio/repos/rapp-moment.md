...
**Version:** `v1.1.0`, from its root VERSION file at the evidence commit. **Channel:** `newest`: RAPP/1 names no long-term-support pin for it, so its newest commit is the one in use.
...
Linked from 6: [double-jump](double-jump.md), [rapp-egg-hub](rapp-egg-hub.md), [rapp-hive-public](rapp-hive-public.md), [rapp-hologram](rapp-hologram.md), [rapp-monorepo](rapp-monorepo.md), [rapp-spine](rapp-spine.md).
