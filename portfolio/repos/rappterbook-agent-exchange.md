...
status: certified
verdict: CLEAN
evidence_commit: 04b7555b0817f0c31fa16bccabfac27fd54a4428
checked: 2026-09-26
...
- Evidence: [`kody-w/rappterbook-agent-exchange` at `04b7555b08`](https://github.com/kody-w/rappterbook-agent-exchange/tree/04b7555b0817f0c31fa16bccabfac27fd54a4428) on `main`, checked 2026-09-26.
...
Clone `kody-w/rappterbook-agent-exchange` at `04b7555b08` and `kody-w/rapp-1` at `591e014`, then run `python3 -B rapp-1/rapp_check.py rappterbook-agent-exchange --json` from the folder that holds both.
