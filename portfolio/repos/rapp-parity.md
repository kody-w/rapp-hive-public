...
**Certified:** rapp-1's own checker gave **COMPLIANT** for [`kody-w/rapp-parity` at `cb5ce3d522`](https://github.com/kody-w/rapp-parity/tree/cb5ce3d5224915f18d797280844d53f75f055bd2).
...
- Checker: [`rapp_check.py` at `591e014`](https://github.com/kody-w/rapp-1/blob/591e014ad39e223b00ab343ae26e5d9a867ebeee/rapp_check.py), verdict **COMPLIANT**, 0 finding(s), 1 passing artifact(s). The raw output stays in the maintainer's sweep folder, outside the Hive; its SHA-256 is `3c35affda7298e7ada505b35b071861be9152701f489cc463576c7196f38d285`.
